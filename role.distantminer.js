...
module.exports.run = function(a, b) {
  ...
  return d.length ? (console.log(JSON.stringify(d)), c = d[0] == c ? {type:"role.cow"} : {type:"travel_to_room", destination_room:_.sample(d)}, new outcomes.PushTask(c)) : new outcomes.Failure("No suitable mining sites found.")
};
